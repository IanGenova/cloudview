...
export function ThemeToggle({
  ...
  if (compact) {
    ...
    return (
      <button
        ...
        className="inline-flex h-10 items-center gap-2 rounded-2xl border border-neutral-200 bg-white px-3 text-xs font-black text-neutral-800 transition hover:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800"
      >
  ...
  return (
    <div className="inline-flex rounded-2xl border border-neutral-200 bg-white p-1 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
      {options.map((option) => {
