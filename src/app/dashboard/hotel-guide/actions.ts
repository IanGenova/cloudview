...
const DEFAULT_POOL_SECTION: DefaultGuideSection = {
  ...
  items: [
    ...
    },
    {
      ...
      content: "Enjoy selected food and beverages served near the pool area.",
      itemType: HotelGuideItemType.DINING,
      iconKey: "Utensils",
      buttonLabel: "View Menu",
      buttonHref: "menu",
    ...
    },
    {
      ...
      content: "Request extra towels or pool assistance from the service team.",
      itemType: HotelGuideItemType.FACILITY,
      iconKey: "Waves",
...
function redirectToGuide(params: {
  error?: string;
  success?: string;
  hotelId?: string | null;
}): never {
...
export async function createGuideSectionAction(formData: FormData) {
  ...
  try {
    ...
    redirectToGuide({ error: "image-upload-failed", hotelId });
  }
  ...
  redirectToGuide({ success: "section-created", hotelId });
}
...
export async function updateGuideSectionAction(formData: FormData) {
  ...
  try {
    ...
    redirectToGuide({ error: "image-upload-failed", hotelId: section.hotelId });
  }
  ...
  redirectToGuide({ success: "section-updated", hotelId: section.hotelId });
}
...
export async function deleteGuideSectionAction(formData: FormData) {
  ...
  revalidatePath("/dashboard/hotel-guide");
  redirectToGuide({ success: "section-deleted", hotelId: section.hotelId });
}
...
export async function createGuideItemAction(formData: FormData) {
  ...
  redirectToGuide({ success: "item-created", hotelId: section.hotelId });
}
...
export async function updateGuideItemAction(formData: FormData) {
  ...
  try {
    ...
    redirectToGuide({ error: "image-upload-failed", hotelId: item.hotelId });
  }
  ...
  redirectToGuide({ success: "item-updated", hotelId: item.hotelId });
}
...
export async function deleteGuideItemAction(formData: FormData) {
  ...
  revalidatePath("/dashboard/hotel-guide");
  redirectToGuide({ success: "item-deleted", hotelId: item.hotelId });
}
...
export async function uploadGuideImageAction(formData: FormData) {
  ...
  redirectToGuide({ success: "image-uploaded", hotelId });
}
...
export async function deleteGuideImageAction(formData: FormData) {
  ...
  redirectToGuide({ success: "image-deleted", hotelId: image.hotelId });
}
...
export async function seedPoolGuideContentAction(formData: FormData) {
  ...
  redirectToGuide({ success: "pool-seeded", hotelId });
}
...
export async function seedDefaultHotelGuideAction(formData: FormData) {
  ...
  revalidatePath("/dashboard/hotel-guide");
  redirectToGuide({ success: "seeded", hotelId });
}
